...
const ScanScreen = () => {
  ...
  return <PdvLayout className="flex flex-col" apiCall={{
    ...
    description: "Este endpoint busca informações do produto pelo código de barras."
      ...
      {lastScanned && <div className="border-2 border-green-500 rounded-md p-4 mb-6 flex items-center bg-green-50">
      ...
      <div className="flex-1 overflow-auto mb-6">
        ...
        {cart.length > 0 ? <div className="space-y-2">
            {cart.map(item => <div key={item.id} className="flex justify-between p-3 bg-gray-50 rounded-md">
                <div>
                  <div>{item.name}</div>
          ...
          </div> : <div className="text-center p-8 text-gray-400">
      ...
      <div className="border-t pt-4 mt-auto">
        <div className="flex justify-between items-center">
          ...
          <Button size="lg" disabled={cart.length === 0} className="bg-dotz-laranja hover:bg-dotz-laranja/90">Pagamento</Button>
        </div>
