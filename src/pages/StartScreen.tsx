    ...
    description: "Este endpoint identifica o cliente (opcional) e prepara a sessão para leitura de produtos."
      ...
      <Dialog open={showDialog} onOpenChange={setShowDialog}>
        <DialogContent className="max-w-md">
          ...
          <DialogFooter className="sm:justify-center gap-4">
            <Button variant="outline" onClick={handleNo} className="w-28 bg-gray-200 hover:bg-gray-300 text-gray-800 border-none">
              Não
            </Button>
            <Button onClick={handleYes} className="w-28 bg-dotz-laranja hover:bg-dotz-laranja/90 text-white">
              Sim
            </Button>
          </DialogFooter>
        </DialogContent>
      ...
      <div className="space-y-8 flex flex-col items-center">
        <div className="mb-4 p-6 bg-dotz-offwhite rounded-full">
          <svg className="w-24 h-24 text-dotz-laranja" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="grid grid-cols-1 gap-6 w-full max-w-lg">
          <Button variant="outline" size="lg" className="h-24 text-lg flex flex-col gap-2 border-2" onClick={handleContinue}>
          ...
          <Button size="lg" className="h-24 text-lg bg-dotz-laranja hover:bg-dotz-laranja/90 text-white" onClick={handleContinue}>
